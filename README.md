...
In the script, `--output_dir` denotes the directory of model checkpoint used for inference. The generated prompts are also saved in this directory.
...
In the script, `--input_path` denotes the path to the prompt generated above.
